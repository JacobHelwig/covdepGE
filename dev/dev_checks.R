# tau = matrix(c(-0.2, 1)); kde = T; alpha = .2; mu = 0;
# sigmasq = 0.5; sigmabetasq_vec = NULL; var_min = 0.01;
# var_max = 10; n_sigma = 8; pi_vec = c(0.2, 1.11); norm = 2;
# scale = 3; tolerance = 1e-9; max_iter = 100.000001;
# edge_threshold = c(0.5, 0.75); sym_method = "mean"; print_time = F;
# CS = F
#
# data_mat[1, 2] <- NA
