...
\begin{itemize}
\item Implement KDE to obtain individual specific bandwidths. Currently, only one global bandwidth is used, and it requires that the user specify it (or use the default, deterministic value). This modification will estimate a unique bandwidth for each individual dependent on the empirical density of $\pmb Z$ resulting from KDE.
...
\bibitem{covDepGM} Dasgupta, Sutanoy, et al. ``An approximate Bayesian approach to covariate dependent graphical modeling." 2021
\end{thebibliography}
