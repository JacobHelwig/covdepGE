...
fig <- ggarrange(ggarrange(plotlist = viz[1:3], ncol = 3, nrow = 1, common.legend = T),
...
```{r, echo = FALSE}
# # save the figure
# setwd("~/PhD application Fa21/TAMU/LaTeX SOP")
# 
# fig2
# 
# tikz('Semester_GPA.tex', width = 2.85, height=2)
# print(fig2) # you *have to* print the object you created
