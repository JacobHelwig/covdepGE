...
variables can be modeled as an undirected graph with
![p](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;p "p")
vertices, where two variables are connected if, and only if, the two
variables are dependent given the remaining variables in the data.
Gaussian graphical modeling (GGM) seeks to capture the CDS of the data
under the assumption that the data are normally distributed. This
distributional assumption is convenient for inference, as the CDS is
given by the sparsity structure of the precision matrix, where the
precision matrix is defined as the inverse covariance matrix of the
data.
...
#> Model fit completed in 2.944 secs
plot(out)
#> [[1]]
```
...
extraneous covariate, also with
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
...
![\\Omega(z_l)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5COmega%28z_l%29 "\Omega(z_l)"),
where
![z_l](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;z_l "z_l")
is the
![l](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;l "l")-th
entry of
![Z](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;Z "Z")
...
is a continuous function mapping from the space of extraneous covariates
to the space of
![p \\times p](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;p%20%5Ctimes%20p "p \times p")
non-singular matrices. Then, for the
![l](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;l "l")-th
observation, the
![(j,k)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%28j%2Ck%29 "(j,k)")
entry of
![\\Omega(z_l)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5COmega%28z_l%29 "\Omega(z_l)")
is non-zero if, and only if, variable
![j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;j "j")
and variable
![k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;k "k")
are dependent given the remaining variables in
![X](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X "X").
...
the structure of
![\\Omega](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5COmega "\Omega")
for each of the observations in
![X](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X "X")
as a continuous function of
![Z](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;Z "Z").
This graph contains an undirected edge between two variables
...
of
![X](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X "X")
as the response and performing a spike-and-slab regression using the
remaining variables
![X_k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_k "X_k")
in
![X](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X "X")
as predictors. To determine if an edge should be added between
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
and
![X_k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_k "X_k"),
the posterior inclusion probability of
![X_k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_k "X_k")
in a regression with
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
fixed as the response
(![PIP_j(X_k)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;PIP_j%28X_k%29 "PIP_j(X_k)"))
and vice versa
(![PIP_k(X_j)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;PIP_k%28X_j%29 "PIP_k(X_j)"))
are symmetrized according to `sym_method` (e.g., by taking the mean of
![PIP_k(X_j)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;PIP_k%28X_j%29 "PIP_k(X_j)")
and
![PIP_j(X_k)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;PIP_j%28X_k%29 "PIP_j(X_k)")).
If the symmetrized
![PIP](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;PIP "PIP")
is greater than `edge_threshold`, an edge will be included between
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
and
![X_k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_k "X_k").
...
![Z](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;Z "Z"),
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
weighted spike-and-slab regressions are performed for each variable
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
fixed as the response. The similarity weights for the
![l](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;l "l")-th
regression are taken with respect to observation
![l](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;l "l")
such that observations having similar values of
![Z](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;Z "Z")
...
![n > p](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n%20%3E%20p "n > p").
...
and
![\\sigma^2\_{\\text{var}}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Csigma%5E2_%7B%5Ctext%7Bvar%7D%7D "\sigma^2_{\text{var}}"),
respectively) and the probability that the coefficient is non-zero
(![\\alpha](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Calpha "\alpha")).
![\\mu](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmu "\mu")
and
![\\alpha](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Calpha "\alpha")
for all coefficients are initialized as
![0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;0 "0")
and
...
CAVI for the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
regressions is performed simultaneously for variable
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
fixed as the response. With each of the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
sets of
![\\alpha](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Calpha "\alpha")
as the rows of an
![n \\times (p - 1)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n%20%5Ctimes%20%28p%20-%201%29 "n \times (p - 1)")
matrix, the CAVI for variable
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
is ended for all
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
regressions when the Frobenius norm of the change in the
![\\alpha](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Calpha "\alpha")
matrix is less than `alpha_tol` or after `max_iter` iterations of CAVI
have been performed.

Note that since the regressions performed for variable
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
and
![X_k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_k "X_k")
...
![p](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;p "p")
workers offers no benefit, since each worker takes on one variable to
fix as the response and perform the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
regressions.
...
(the prior probability of inclusion),
![\\sigma^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Csigma%5E2 "\sigma^2")
(the prior residual variance), and
![\\sigma\_\\beta^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Csigma_%5Cbeta%5E2 "\sigma_\beta^2")
(the prior variance of the slab). `covdepGE` offers
![3](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;3 "3")
methods for hyperparameter specification via the `hp_method` argument:
`grid_search`, `model_average`, and `hybrid`. Empirically, `grid_search`
offers the best sensitivity and `model_average` offers the best
specificity, while `hybrid` sits between the other two methods in both
metrics.
...
and
![\\pi](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cpi "\pi"),
respectively). Each of the methods gives an approach for selecting
points from this grid.
...
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
regressions for a variable
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
fixed as the response. Thus, all observations use the same set of
hyperparameters for the regression on
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j").

Instead of selecting only one model as in `grid_search`, models are
averaged over in `model_average`. With
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
fixed as the response, the unnormalized weights for each grid point used
to perform this averaging is calculated by exponentiating the ELBO for
each of the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
regressions. Note that since the ELBO for a given grid point will vary
across the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
regressions due to differing similarity weights, each of the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
sets of averaging weights will be unique.

Finally, `hybrid` combines `grid_search` and `model_average`. Fixing
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
as the response, for each
![\\pi](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cpi "\pi")
candidate in `pip`, the point in the grid defined by the Cartesian
product of `ssq` and `sbsq` is selected by maximizing the total ELBO
summed across the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
regressions. The resulting models for each of the
![\\pi](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cpi "\pi")
candidates are then averaged using the exponentiated ELBO for each of
the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
...
using the
![n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n "n")
models that maximized the total ELBO in the first step. Setting
`max_iter_grid` to be less than `max_iter` (as is the default) will
...
lower end point. The number of points in each grid is
![5](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;5 "5")
by default. Grids include end points, and the number of points in each
grid is controlled by the arguments `nssq`, `nsbsq`, and `npip`. The
lower endpoints (`ssq_lower`, `sbsq_lower`, and `pip_lower`) are all
`1e-5` by default. The upper endpoints are calculated dependent on the
variable
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
fixed as the response.

`ssq_upper` is simply the variance of
![X_j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X_j "X_j")
times `ssq_mult`. By default, `ssq_mult` is `1.5`.
...
estimate to the number of non-zero coefficients is
![0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;0 "0")
or
![p - 1](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;p%20-%201 "p - 1"),
this estimate is changed to
![1](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;1 "1")
or
![p - 2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;p%20-%202 "p - 2")
(respectively) to ensure that `pip_upper` is greater than
![0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;0 "0")
and less than
![1](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;1 "1").

Finally, an upper bound is induced on
![\\sigma\_\\beta^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Csigma_%5Cbeta%5E2 "\sigma_\beta^2")
by deriving a rough upper bound for the signal-to-noise ratio that
depends on
![\\sigma\_\\beta^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Csigma_%5Cbeta%5E2 "\sigma_\beta^2").
Let
...
![X’](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X%E2%80%99 "X’").
Under the simplifying assumptions that the expected values of
![X’](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X%E2%80%99 "X’")
and the spike-and-slab regression coefficients
...
and
![\\beta](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbeta "\beta")
are independent, the variance of the dot product of
![X’](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;X%E2%80%99 "X’")
with
![\\beta](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbeta "\beta")
is
![\\pi\\cdot \\sigma^2 \\cdot\\sigma\_\\beta^2\\cdot S^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cpi%5Ccdot%20%5Csigma%5E2%20%5Ccdot%5Csigma_%5Cbeta%5E2%5Ccdot%20S%5E2 "\pi\cdot \sigma^2 \cdot\sigma_\beta^2\cdot S^2").
Thus, the signal-to-noise ratio under these assumptions is given by
![\\pi\\cdot \\sigma\_\\beta^2\\cdot S^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cpi%5Ccdot%20%5Csigma_%5Cbeta%5E2%5Ccdot%20S%5E2 "\pi\cdot \sigma_\beta^2\cdot S^2").
Replacing
![\\pi](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cpi "\pi")
with `pip_upper` and
![\\sigma\_\\beta^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Csigma_%5Cbeta%5E2 "\sigma_\beta^2")
with `sbsq_upper` gives an upper bound on the signal-to-noise ratio.
Setting this bound equal to `snr_upper` gives an expression for
`sbsq_upper`.
...
![l](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;l "l")
is
![\\phi\_{\\tau_l}(\|\|z_l - z_k\|\|)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cphi_%7B%5Ctau_l%7D%28%7C%7Cz_l%20-%20z_k%7C%7C%29 "\phi_{\tau_l}(||z_l - z_k||)").
Here,
![\|\| \\cdot \|\|](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%20%5Ccdot%20%7C%7C "|| \cdot ||")
denotes the norm specified by the `norm` argument,
![z_l](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;z_l "z_l")
and
...
observations,
![\\phi\_{\\tau_l}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cphi_%7B%5Ctau_l%7D "\phi_{\tau_l}")
...
of
![Z](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;Z "Z"),
and the updated bandwidths from the second step are used for `tau`.
